...
public static class Transliteration
{
    ...
    public static string Generate(string text, bool toLowerCase = true)
    {
        if (toLowerCase)
        {
            return Generate(text, TransliterationType.ISO).ToLower();
        }
        else
        {
            return Generate(text, TransliterationType.ISO);
        }
    }
    public static string Generate(string text, TransliterationType type)
    {
        string output = text;
