...
namespace GoldAggregator.Parser.DbContext.Migrations
{
    ...
    [Migration("20220524192432_SeedDealers")]
    partial class SeedDealers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldAggregator.Parser.Entities.CoinPriceClick", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GoldAggregator.Parser.Entities.CoinPriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f58f2524-d302-40a2-bd64-42a07b2bbf78",
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("GoldAggregator.Parser.Entities.CoinPriceClick", b =>
                {
                    b.HasOne("GoldAggregator.Parser.Entities.CoinPriceHistory", "CoinHistory")
